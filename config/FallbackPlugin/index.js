...
class FallbackPlugin {
    ...
    buildParentThemeRegExp() {
        const relativeToAdf = this.options.parentRoot.split('/design/frontend')[1];
    ...
    apply(resolver) {
        resolver.getHook('resolve').tapAsync('FallbackPlugin', (request, resolveContext, callback) => {
            ...
            const pathIsCustom = !!request.path.match(/\/design\/frontend\/Anvol\/pwa\//);
            ...
            const requestIsCustom = !!request.request.match(/\/design\/frontend\/Anvol\/pwa\//);
